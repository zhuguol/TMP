...
<@CommonQueryMacro.page title="大额补报报文补录">
		<@CommonQueryMacro.CommonQuery id="AmlABHdsColl2" init="false" submitMode="all" navigate="false" >
	...
	var sysTxdate = ${statics["com.huateng.ebank.business.common.GlobalInfo"].getCurrentInstanceWithoutException().getTxdate()?string("yyyyMMdd")};   
		...
		//	AmlABHdsColl2_interface_dataset.setValue("qworkDateStart",sysTxdate);
		//	AmlABHdsColl2_interface_dataset.setValue("qworkDateEnd",sysTxdate);
		//}
		...
		var record = AmlABHdsColl2_dataset.firstUnit;
			var chk=0;
	...
	function btReport_onClickCheck(button){
	 ...
	 function btReport_postSubmit(button){
    	...
    	AmlABHdsColl2_dataset.flushData(AmlABHdsColl2_dataset.pageIndex);
     }	
	   //撤销上报
