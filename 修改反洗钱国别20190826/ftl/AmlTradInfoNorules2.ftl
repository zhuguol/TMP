...
<@CommonQueryMacro.page title="大额无规则交易查询">
		<@CommonQueryMacro.CommonQuery id="AmlTradInfoNorules2" init="false" submitMode="all" navigate="false" >
	...
	function initCallGetter_post() {
		AmlTradInfoNorules2_interface_dataset.setValue("qetlDate",sysTxdate);
	}
		
	function btDownload_onClick(){
		window.document.getElementById("btDownload").disabled = true;
		createTimerIfNull();
		var qetlDate = formatDate(AmlTradInfoNorules2_interface_dataset.getValue("qetlDate"));
		var qcustNo = AmlTradInfoNorules2_interface_dataset.getValue("qcustNo");
		var qbussFlag = AmlTradInfoNorules2_interface_dataset.getValue("qbussFlag");
		var sourceFlag = 2;
		window.location.href = "${contextPath}/filedownload/AmlNoRulesDownoloadAction.do?qbussFlag="+qbussFlag+"&qcustNo="+qcustNo+"&qetlDate="+qetlDate+"&sourceFlag="+sourceFlag;
	}
