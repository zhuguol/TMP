...
<table align="left">
    <tr>
        <td>
            <@CommonQueryMacro.CommonQuery id="AmlTradInfoAll" init="false" submitMode="all">
            <table width="100%">
                <tr>
...
<script language="JavaScript">
	...
	function btConfirm_onClickCheck(button){
			...
			if(chk==0){
				...
				AmlTradInfoAll_dataset.setParameter("reportId",reportId);
				AmlTradInfoAll_dataset.setParameter("workDate",workDate);
				return true;
			}
	   }
