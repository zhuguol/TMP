...
<script type='text/javascript' src='${contextPath}/dwr/interface/CreateReportFileService.js'> </script>
		<@CommonQueryMacro.CommonQuery id="AMLGenReportFileBS" init="false" submitMode="all" navigate="false" >
			<table align="left"  width="100%">
                ...
                <tr>
		    		<td colspan="2">
						<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="" fieldStr="brno[120],workDate[120],currentfile[120],reportType[120],noCollNum[120],noReportNum[120],noPackageNum[120],isPackageNum[120],oper[120]"  width="100%"  readonly="true"/>
		      		</td>
		    	</tr>
			</table>
...
<script language="JavaScript">
	...
	function initCallGetter_post() {
		AMLGenReportFileBS_interface_dataset.setValue("qcurrentfile","BS");
	}
	...
	function createFile(workDate,reportType){
		if(window.confirm('确定要将交易日期为：['+workDate+']报文类型为：['+reportType+']的信息进行打包吗？')){
		   	CreateReportFileService.execGenAMLFile(workDate,"BS",reportType,function(msg){
		   	   alert(msg);
		   	});
	   	}
	}
