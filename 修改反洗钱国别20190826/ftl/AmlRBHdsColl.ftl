...
<@CommonQueryMacro.page title="大额重发报文补录">
		<@CommonQueryMacro.CommonQuery id="AmlRBHdsColl" init="false" submitMode="all" navigate="false" >
	...
	var sysTxdate = ${statics["com.huateng.ebank.business.common.GlobalInfo"].getCurrentInstanceWithoutException().getTxdate()?string("yyyyMMdd")};   
		...
		//	AmlRBHdsColl_interface_dataset.setValue("qworkDateStart",sysTxdate);
		//	AmlRBHdsColl_interface_dataset.setValue("qworkDateEnd",sysTxdate);
		//}
		...
		var record = AmlRBHdsColl_dataset.firstUnit;
			var chk=0;
	...
	function btReport_onClickCheck(button){
	 ...
	 function btReport_postSubmit(button){
    	...
    	AmlRBHdsColl_dataset.flushData(AmlRBHdsColl_dataset.pageIndex);
     }	
	   //撤销上报
