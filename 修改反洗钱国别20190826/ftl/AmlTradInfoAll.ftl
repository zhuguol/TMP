...
<script language="JavaScript">
	...
	function initCallGetter_post() {
		AmlTradInfoAll_interface_dataset.setValue("qtradTimeStart",sysTxdate);
		AmlTradInfoAll_interface_dataset.setValue("qtradTimeEnd",sysTxdate);
	}
		
	function btDownload_onClick(){
		window.document.getElementById("btDownload").disabled = true;
		createTimerIfNull();
		var qworkDateStart = formatDate(AmlTradInfoAll_interface_dataset.getValue("qtradTimeStart"));
		var qworkDateEnd = formatDate(AmlTradInfoAll_interface_dataset.getValue("qtradTimeEnd"));
		var qcustNo = AmlTradInfoAll_interface_dataset.getValue("qcustNo");
		var qticd = AmlTradInfoAll_interface_dataset.getValue("qticd");
		window.location.href = "${contextPath}/filedownload/AmlDownoloadAction.do?qticd="+qticd+"&qcustNo="+qcustNo+"&qworkDateStart="+qworkDateStart+"&qworkDateEnd="+qworkDateEnd;
	}
