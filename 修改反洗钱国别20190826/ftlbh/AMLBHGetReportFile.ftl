...
<script type='text/javascript' src='${contextPath}/dwr/interface/GetReportFileService.js'> </script>
		<@CommonQueryMacro.CommonQuery id="AMLBHGetReportFile" init="false" >
			<table align="left"  width="100%">
                ...
                <tr>
		    		<td colspan="2">
						<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="" fieldStr="brno[120],workDate[120],currentfile[120],reportType[120],noCollNum[120],noReportNum[120],noCheckNum[120],isCheckNum[120],noPackageNum[120],isPackageNum[120],oper[120]" width="100%" height="480"  hasFrame="true" readonly="true"/>
		      		</td>
		    	</tr>
			</table>
...
<script language="JavaScript">
 	...
 	function initCallGetter_post() {
		AMLBHGetReportFile_interface_dataset.setValue("qcurrentfile","BH");
	}
	...
	function createFile(workDate,reportType){
		if(window.confirm('确定要将交易日期为：['+workDate+']报文类型为：['+reportType+']进行打包吗？')){
		   	GetReportFileService.execGenAMLFile(workDate,"BH",reportType,function(msg){
		   	   alert(msg);
		   	});
		}
	}
