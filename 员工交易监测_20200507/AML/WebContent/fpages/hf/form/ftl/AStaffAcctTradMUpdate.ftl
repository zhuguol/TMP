...
<@CommonQueryMacro.CommonQuery id="AStaffAcctTradMUpdate" init="true" insertOnEmpty="true" submitMode="allchange" navigate="false">
				   ...
				   <td width="25%">
				   		<@CommonQueryMacro.GroupBox id="groupbox1" label="调查信息" expand="true">
							<table frame="void" class="grouptable" width="100%">
								...
								<tr>   
									<td width="25%" width="25%" colspan="1" align="right" nowrap class="labeltd">初步调查结论(by OPS)</td>
									<td width="25%" width="25%" class="datatd" id="tdinvesResultByOps"><@CommonQueryMacro.SingleField fId="invesResultByOps"/></td>
									<td width="25%" width="25%" colspan="1" align="right" nowrap class="labeltd">已上报案件编号</td>
								...
								<tr>  
									<td width="25%" width="25%" colspan="1" align="right" nowrap class="labeltd">反馈结果(从FCTM或者GB/GF指定部门)</td>
							    	<td width="25%" width="25%" class="datatd" id="tdfeedbackFrom"><@CommonQueryMacro.SingleField fId="feedbackFrom"/></td>  
								...
								<tr>
									...
									<td width="25%" width="25%" colspan="1" align="right" nowrap class="labeltd">当日已有告警标识</td>
							    	<td width="25%" width="25%" class="datatd" id="tdalterFlag"><@CommonQueryMacro.SingleField fId="alterFlag"/></td>
								<tr>
							    	<td width="25%" width="25%" colspan="1" align="right" nowrap class="labeltd">当月告警UAR_NO</td>
...
<script language="javascript">
	...
	function initCallGetter_post(){
  		//详细页面设置只读、其他按钮全部屏蔽
  		if(op == "detail"){
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("dataDate",true);//数据日期
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("alertId",true);//告警号
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("ruleCode",true);//规则代码
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("alterFlag",true);//当日已有告警标识
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("alterUar",true);//当月告警UAR_NO
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("branCode",true);//分行号
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("custNo",true);//客户号
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("custName",true);//客户名称/姓名
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("custIdCertNo",true);//客户身份证件号码
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("ctnt",true);//客户国籍
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("ctar",true);//客户住址/经营地址
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("staffNumber",true);//员工编号
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("staffDepartment",true);//员工所在部门
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("staffJobTitle",true);//员工职位名称
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("reportDOrM",true);//日报/月报
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("appearanceTime",true);//(日报当月/月报当季)被抓出次数
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("checkDate",true);//初步调查日期
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("investigator",true);//调查者
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("status",true);//调查阶段
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("managerName",true);//直线经理姓名
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("invesResultByOps",true);//初步调查结论(by OPS)
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("caseId",true);//已上报案件编号
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("reportDate",true);//上报日期
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("potentialCaseType",true);//(初步调查)上报的可疑类型
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("feedbackDate",true);//收到反馈时间
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("concludedType",true);//(收到反馈)判定的可疑类型
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("feedbackFrom",true);//反馈结果(从FCTM或者GB/GF指定部门)
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("comfirmedSusp",true);//是否判定可疑(及由哪方判定)
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("qcComment",true);//质检意见
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("alterFlag",true);//当日已有告警标识
  			AStaffAcctTradMUpdate_dataset.setFieldReadOnly("alterUar",true);//当月告警UAR_NO
  			//将保存按钮隐藏
	...
	function btnSubmit_onClickCheck(){
		var approveStatusChoose = AStaffAcctTradMUpdate_dataset.getValue("approveStatusChoose");
		var approveResultChoose = AStaffAcctTradMUpdate_dataset.getValue("approveResultChoose");
		var recordUpdTlrChoose = AStaffAcctTradMUpdate_dataset.getValue("recordUpdTlrChoose");
		...
		AStaffAcctTradMUpdate_dataset.setParameter("approveStatusChoose",approveStatusChoose);
		AStaffAcctTradMUpdate_dataset.setParameter("approveResultChoose",approveResultChoose);
	    AStaffAcctTradMUpdate_dataset.setParameter("recordUpdTlrChoose",recordUpdTlrChoose);
