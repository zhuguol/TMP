...
<@CommonQueryMacro.CommonQuery id="AStaffAcctTradMRRBUpdate" init="true" insertOnEmpty="true" submitMode="allchange" navigate="false">
...
<script language="javascript">
	...
	function initCallGetter_post(){
  		...
  		if(op == "detail"){
  			...
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("ctnt",true);//客户国籍
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("ctar",true);//客户住址/经营地址
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("staffNumber",true);//员工编号
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("staffDepartment",true);//员工所在部门
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("staffJobTitle",true);//员工职位名称
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("reportDOrM",true);//日报/月报
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("appearanceTime",true);//(日报当月/月报当季)被抓出次数
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("checkDate",true);//初步调查日期
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("investigator",true);//调查者
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("status",true);//调查阶段
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("managerName",true);//直线经理姓名
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("invesResultByOps",true);//初步调查结论(by OPS)
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("caseId",true);//上报案件编号
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("reportDate",true);//上报日期
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("potentialCaseType",true);//(初步调查)上报的可疑类型
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("feedbackDate",true);//收到反馈时间
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("concludedType",true);//(收到反馈)判定的可疑类型
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("feedbackFrom",true);//反馈结果(从FCTM或者GB/GF指定部门)
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("comfirmedSusp",true);//是否判定可疑(及由哪方判定)
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("alterUar",true);//反馈案件编号
  			AStaffAcctTradMRRBUpdate_dataset.setFieldReadOnly("alterFlag",true);//当月日报上报案件编号
  			//将保存按钮隐藏
