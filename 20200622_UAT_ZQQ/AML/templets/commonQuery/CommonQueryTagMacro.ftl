...
<html>
  <head>
	...
	<script type='text/javascript' src='${contextPath}/dwr/interface/HfAmlDwrService.js'> </script>
	<script type="text/javascript" src="${contextPath}/templets/ui/js/custom.js"></script>
	<script type='text/javascript' src='${contextPath}/dwr/interface/CreditCardDwrFunction.js'> </script>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
                ...
                <td class="datatd" nowrap width="30%">
                    <input class="easyui-numberbox" id="s_p" type="text" name="${CommonQueryConfig.getId()}_startPage" min="1" value="1" style="width:40px" size="10" err="起始页必须是数字,且在有效页码范围内"/>&nbsp;~&nbsp;
                    <input class="easyui-numberbox" id="e_p" type="text" name="${CommonQueryConfig.getId()}_endPage" min="1" value="${maxpage}" style="width:40px" size="10" err="结束页必须是数字,且在有效页码范围"/>
                </td>
                <td class="labeltd" width="20%" align="left" nowrap><@ui18n.message "PageQryExp.all"/></td>
                <td class="datatd" nowrap>
                    <input id="a_p" type="checkbox" name="${CommonQueryConfig.getId()}_allPage" value="1"  err="错误，请重新勾选" onclick='checkAllpage(this,s_p,e_p)'/>
                </td>
            </tr>
            <tr>
