...
insert into FUNCTION_INFO (FUNCID, FUNCNAME, PAGEPATH, LOCATION, ISDIRECTORY, LASTDIRECTORY, SHOWSEQ, FUNC_CLASS, FUNC_TYPE, WORKFLOW_FLAG, UP_FUNC_CODE, FUNC_DESC, STATUS, EFFECT_DATE, EXPIRE_DATE, TIMESTAMPS, MISCFLGS, MISC, ICON_CLS)
values ('2304', 'Actual Time Query Report', '/fpages/hf/form/ftl/AStaffAcctTradActualTimeQuery.ftl', 2, 0, '230', 4, null, '1', null, null, null, '1', null, null, null, null, null, 'icon-edit');
commit;
...
insert into FUNCTION_INFO (FUNCID, FUNCNAME, PAGEPATH, LOCATION, ISDIRECTORY, LASTDIRECTORY, SHOWSEQ, FUNC_CLASS, FUNC_TYPE, WORKFLOW_FLAG, UP_FUNC_CODE, FUNC_DESC, STATUS, EFFECT_DATE, EXPIRE_DATE, TIMESTAMPS, MISCFLGS, MISC, ICON_CLS)
values ('2404', 'Actual Time Query Report', '/fpages/hf/form/ftl/AStaffAcctTradRRBActualTimeQuery.ftl', 2, 0, '240', 4, null, '1', null, null, null, '1', null, null, null, null, null, 'icon-edit');
commit;