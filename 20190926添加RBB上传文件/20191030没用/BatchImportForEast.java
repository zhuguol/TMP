...
//import com.huateng.excel.imp.BatchImportController;
...
public class BatchImportForEast {
    ...
    public static String EXimportxlsx(File file, String fileDate, String areaFlag, String fileName,
        ...
        try {
            ...
            //add 20190926
            //文件名不为WMR_CHANGE_INFO、CCS_CHANGE_INFO。但是与_CHANGE_INFO相匹配的都存到RBB_CHANGE_INFO表中
//            if(fileName.indexOf("_CHANGE_INFO")!=-1 && 
//        			fileName.indexOf("WMR_CHANGE_INFO")==-1 && 
//        			fileName.indexOf("CCS_CHANGE_INFO")==-1 ){
//            	rs = st.executeQuery("select TABLE_NAME,COLUMN_NAME from TB_TABLEINFO where FILE_NAME = '" + BatchImportController.TABLE_NAME + "' ORDER BY ORDNUM");
//            }else{
//            	rs = st.executeQuery("select TABLE_NAME,COLUMN_NAME from TB_TABLEINFO where FILE_NAME = '" + fileName + "' ORDER BY ORDNUM");
//            }
            while (rs.next()) {
