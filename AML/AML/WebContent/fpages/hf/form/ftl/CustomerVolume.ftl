...
<@CommonQueryMacro.page title="CustomerVolume">
	<@CommonQueryMacro.CommonQuery id="CustomerVolumeByBranch" init="false" submitMode="allchange" navigate="false" >
		<table align="left" id="CustomerVolumeByBranch" width="100%">
		    ...
		    <tr>
		    	<td colspan="2">
					<@CommonQueryMacro.DataTable id ="datatable" paginationbar="exportBNB" fieldStr="searchDate[120],branch[100],branchName[150],customerVolumeWpb[150],customerVolumeGbm[150],customerVolumeCmb[150],customerVolumeAll[150]" width="100%" hasFrame="true" readonly="true"/>
		      	</td>
		    </tr>
		</table>
