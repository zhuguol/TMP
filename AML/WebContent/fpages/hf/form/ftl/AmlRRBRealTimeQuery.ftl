...
<@CommonQueryMacro.CommonQuery id="AmlRRBRealTimeQuery" init="false" insertOnEmpty="true" submitMode="allchange" navigate="false">
...
<script language="javascript">
	...
	function initCallGetter_post(){
  		//交易起始日期
		AmlRRBRealTimeQuery_interface_dataset.setValue("etlDateStart",sysTxdate);
		//交易结束日期
		AmlRRBRealTimeQuery_interface_dataset.setValue("etlDateEnd",sysTxdate);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("reportPeriod",true);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("caseToFCTM",true);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("caseToPresident",true);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("caseClosedByFCTM",true);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("caseClosedByPresident",true);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("casePendingByFCTM",true);
		AmlRRBRealTimeQuery_dataset.setFieldReadOnly("casePendingByPresident",true);
	}
</script>
