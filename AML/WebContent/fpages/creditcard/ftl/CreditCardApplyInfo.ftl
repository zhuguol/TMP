...
function showCreditCard(id) {
	locate(id);
	var url = "/fpages/creditcard/ftl/CreditCardDtl.ftl?op=detail&id="+id+"&flag="+flag;
...
function editCreditCard(id) {
	...
	var url = "/fpages/creditcard/ftl/CreditCardDtl.ftl?op=update&id="+id+"&level="+level+"&qs="+qs+"&qe="+qe+"&flag="+flag;
