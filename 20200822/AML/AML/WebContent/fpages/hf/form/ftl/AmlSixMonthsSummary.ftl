...
<@CommonQueryMacro.page title="AmlSixMonthsSummary报表">
	<@CommonQueryMacro.CommonQuery id="AmlSixMonthsSummaryBranch" init="false" submitMode="allchange" navigate="false" >
		<table align="left" id="AmlSixMonthsSummaryBranch" width="100%">
		    ...
		    <tr>
		    	<td colspan="2">
					<@CommonQueryMacro.DataTable id ="datatable" paginationbar="btnDownLoadB" fieldStr="dataDate[100],levelNo[180],levelName[180],sccToFcr[220],sccToMis[220],sccToSafe[220],sccTotal[220]" width="100%" height="600" hasFrame="true" readonly="true"/>
		      	</td>
		    </tr>
		</table>
	...
	<@CommonQueryMacro.CommonQuery id="AmlSixMonthsSummaryDepartment" init="false" submitMode="allchange" navigate="false" >
		<table align="left" id="AmlSixMonthsSummaryDepartment" width="100%">
		    ...
		    <tr>
		    	<td colspan="2">
					<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="btnDownLoadD" fieldStr="dataDate[100],levelNo[180],sccToFcr[220],sccToMis[220],sccToSafe[220],sccTotal[220]" width="100%" height="600" hasFrame="true" readonly="true"/>
		      	</td>
		    </tr>
		</table>
	</@CommonQueryMacro.CommonQuery>
<script language="JavaScript">
	...
	function btnDownLoadB_onClick(){
		...
		+dataYears+"&dataDates="+dataDates+"&dataFlags="+dataFlags+"&tableName="+tableName;
	}
