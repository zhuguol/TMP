...
<script language="javascript">
	...
	function initCallGetter_post() {
		AmlUboReportInfoH_interface_dataset.setValue("dataDateStart",sysTxdate);
		AmlUboReportInfoH_interface_dataset.setValue("dataDateEnd",sysTxdate);
	}
	//下载
	function btnDownLoad_onClick(){
		var dataDateStart = AmlUboReportInfoH_interface_dataset.getValue("dataDateStart");
		var dataDateEnd = AmlUboReportInfoH_interface_dataset.getValue("dataDateEnd");
