...
<@CommonQueryMacro.CommonQuery id="AmlUboReportInfoGb" init="true" submitMode="all">
	<table align="left"  width="100%">
  		<tr>
      		<td colspan="2">
          		<@CommonQueryMacro.DataTable id ="datatable1" paginationbar="btnDownLoad" fieldStr="dataDate[200],custNo[200],custName[200],pName[200],reason[300]" width="100%" readonly="true"/><br />
        	</td>
        </tr>
   </table>
...
<script language="javascript">
	...
	function btnDownLoad_onClick(){
		...
		createTimerIfNull();
		window.location.href = "${contextPath}/filedownload/AmlUboReportAction.do?tableName="+tableName;
	}
